...
import { pgTable, text, varchar, timestamp, pgEnum, uuid, type AnyPgColumn } from 'drizzle-orm/pg-core';
...
export const profiles = pgTable('profiles', {
    ...
    pin: text('pin'),
    adminId: uuid('admin_id').references((): AnyPgColumn => profiles.id, { onDelete: 'set null' }),
    age: integer('age'),
