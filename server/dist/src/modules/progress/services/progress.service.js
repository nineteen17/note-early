...
export class ProgressService {
    ...
    async verifyAdminManagesStudent(adminId, studentId) {
        try {
     ...
     */
    async updateProgress(progressId, updates, isAdminUpdate = false) {
     ...
     */
    async getAdminStudentsProgress(adminId) {
     ...
     */
    async getStudentProgressForAdmin(adminId, studentId) {
     ...
     */
    async getDetailedStudentModuleProgressForAdmin(adminId, studentId, moduleId) {
