...
function mapStripeStatusToDbStatus(stripeStatus) {
    ...
    if (validDbStatuses.includes(stripeStatus)) {
        return stripeStatus;
    }
...
export class WebhookService {
    ...
    async handleInvoicePaymentFailed(invoice) {
        ...
        await db
            ...
            .where(and(eq(customerSubscriptions.stripeCustomerId, stripeCustomerId), eq(customerSubscriptions.id, stripeSubscriptionId)));
