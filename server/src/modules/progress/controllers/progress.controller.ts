...
import { ProgressService, SubmitParagraphSummaryInput, CreateProgressInput, UpdateProgressInput } from '../services/progress.service';
import { db } from '@/db';
import { z } from 'zod';
 ...
 */
export const updateProgressByTeacher = async (req: Request, res: Response, next: NextFunction) => {
  try {
